...
export default function TermosPage() {
  return (
    <article className="space-y-4 text-pedra-700">
      <h1 className="titulo text-3xl text-pinho-900">Termos de uso</h1>
      <p className="text-sm text-pedra-500">Última atualização: rascunho — a ser revisado juridicamente antes do lançamento.</p>

      <h2 className="mt-6 titulo-secao text-xl text-pedra-900">1. O serviço</h2>
      <p>
      ...
      <h2 className="mt-6 titulo-secao text-xl text-pedra-900">2. Cadastro</h2>
      <p>
      ...
      <h2 className="mt-6 titulo-secao text-xl text-pedra-900">3. Pagamento e cancelamento</h2>
      <p>
      ...
      <h2 className="mt-6 titulo-secao text-xl text-pedra-900">4. Responsabilidades</h2>
      <p>
      ...
      <p className="mt-8 text-sm text-pedra-500">Conteúdo provisório. Não constitui aconselhamento jurídico.</p>
    </article>
  );
}
