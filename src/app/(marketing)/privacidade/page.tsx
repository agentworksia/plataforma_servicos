...
export default function PrivacidadePage() {
  return (
    <article className="space-y-4 text-pedra-700">
      <h1 className="titulo text-3xl text-pinho-900">Política de Privacidade</h1>
      <p className="text-sm text-pedra-500">Última atualização: rascunho — a ser revisado antes do lançamento.</p>

      <h2 className="mt-6 titulo-secao text-xl text-pedra-900">Dados que coletamos</h2>
      <p>
      ...
      <h2 className="mt-6 titulo-secao text-xl text-pedra-900">Como usamos</h2>
      <p>
      ...
      <h2 className="mt-6 titulo-secao text-xl text-pedra-900">Documentos e acesso</h2>
      <p>
      ...
      <h2 className="mt-6 titulo-secao text-xl text-pedra-900">Seus direitos</h2>
      <p>
      ...
      <p className="mt-8 text-sm text-pedra-500">Conteúdo provisório.</p>
    </article>
  );
}
