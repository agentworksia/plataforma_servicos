...
export default function SejaProfissionalPage() {
  return (
    <article>
      <h1 className="titulo text-3xl text-pinho-900">Trabalhe como diarista na plataforma</h1>
      <p className="mt-4 text-pedra-700">
      ...
      <ul className="mt-6 space-y-2 text-pedra-700">
