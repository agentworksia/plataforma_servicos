...
export default async function AdminPage() {
  ...
  return (
    <section>
      <h1 className="titulo text-2xl text-pinho-900">Visão geral</h1>
      ...
      <div className="mt-6 grid gap-4 sm:grid-cols-2">
        <Link
          ...
          className="rounded-xl border border-pedra-200 p-5 transition-colors hover:border-pinho-300 hover:bg-pinho-50/40"
        >
          <p className="titulo text-3xl text-pinho-900">{pendentes}</p>
